...
void R_Config_MTU3_MTU4_Create(void)
{
    ...
    /* MTU channel 3 is used as complementary PWM mode 2 */
    ...
    MTU.TOCR2A.BYTE = _00_MTU_TOLBR_DIS | _20_MTU_OLS3N_LH | _10_MTU_OLS3P_LH | _08_MTU_OLS2N_LH | _04_MTU_OLS2P_LH | 
    ...
    MTU4.TADCORA = _0002_TADCORA_VALUE;
    MTU4.TADCOBRA = _0002_TADCOBRA_VALUE;
    MTU4.TADCR.WORD = _0080_MTU_UTAE_ENABLE | _0000_MTU_DTAE_DISABLE | _0000_MTU_BF_DISABLE;
